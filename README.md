...
|  이름  | 자료                                    |              팀              |
| :----: | --------------------------------------- | :--------------------------: |
| 강동현 | [이항분포, 제곱근법칙 등](week6/강동현) | 기초 통계, 회귀 분석 및 검증 |
| 김동규 |                                         | 기초 통계, 회귀 분석 및 검증 |
...
| 강동현 |                                                              | 기초 통계, 회귀 분석 및 검증 |
| 김동규 |                                                              | 기초 통계, 회귀 분석 및 검증 |
| 김혜련 | [Bootstrapping](week7/김혜련)                                | 기초 통계, 회귀 분석 및 검증 |
| 박지훈 |                                                              | 기초 통계, 회귀 분석 및 검증 |
| 이은용 |                                                              | 기초 통계, 회귀 분석 및 검증 |
| 이혜진 |                                                              | 기초 통계, 회귀 분석 및 검증 |
...
**참석자**: 김동규, 김혜련, 이은용, 이혜진, 조윤기  
**내용**: 

|  이름  | 자료                                                         |              팀              |
| :----: | ------------------------------------------------------------ | :--------------------------: |
| 김혜련 | [유의성검정의 개념 및 적용](week8/김혜련)                    | 기초 통계, 회귀 분석 및 검증 |
| 김동규 | [중심극한정리,유의성 검정 등](week8/김동규/중심극한_유의성검정.ipynb) | 기초 통계, 회귀 분석 및 검증 |
| 이은용 |                                                              | 기초 통계, 회귀 분석 및 검증 |
| 이혜진 | [Ch17 평균의 정확성](week8/이혜진/Ch17.md)<br />[Ch18 유의성 검정](week8/이혜진/Ch18.md)<br />[Ch19 두 집단간 평균의 차이에 대한 검정](week8/이혜진/Ch19.md)<br />[Ch20 회귀분석과 유의성 검정](week8/이혜진/Ch20.md) | 기초 통계, 회귀 분석 및 검증 |
| 조윤기 | [미분 기초 정리](week8/조윤기/lec09/lec09-2.md)<br />[Deep Network 학습시키기: backpropagation](week8/조윤기/lec09/lec09-3.md)<br />[Neural Net for XOR](week8/조윤기/lec09/lec09.ipynb)<br />[Exercise: MNIST with NN](week8/조윤기/lec09/lec09-exercise.ipynb) |         딥러닝 기초          |
...
|  이름  | 자료                                                         |              팀              |
| :----: | ------------------------------------------------------------ | :--------------------------: |
| 강동현 | [카이제곱검정 정의 및 예시](week9/강동현)                    | 기초 통계, 회귀 분석 및 검증 |
| 김동규 | [카이제곱검정](week9/김동규/산본스터디(3_17).ipynb)          | 기초 통계, 회귀 분석 및 검증 |
...
|  이름  | 자료                                                      |              팀              |
| :----: | --------------------------------------------------------- | :--------------------------: |
| 강동현 | [](week9/강동현)                                          | 기초 통계, 회귀 분석 및 검증 |
| 김동규 |                                                           | 기초 통계, 회귀 분석 및 검증 |
| 김혜련 |                                                           | 기초 통계, 회귀 분석 및 검증 |
| 박지훈 |                                                           | 기초 통계, 회귀 분석 및 검증 |
| 이은용 |                                                           | 기초 통계, 회귀 분석 및 검증 |
| 이혜진 | [Ch22 유의성 검정에 대한 보충설명](week10/이혜진/Ch22.md) | 기초 통계, 회귀 분석 및 검증 |
| 이정환 |                                                           |         딥러닝 기초          |
| 조윤기 | [CNN introduction](week10/조윤기/lec11/lec11.md)          |         딥러닝 기초          |

<br>

### 열한 번째 스터디 (2020. 3. 31)

**참석자**: 강동현, 김혜련, 박지훈, 이은용, 이혜진, 김동규  
...
| :----: | --------------------------------------------------------- | :--------------------------: |
| 강동현 |                                                           | 기초 통계, 회귀 분석 및 검증 |
| 김동규 |[단순,다항,리지,라쏘,엘라스티넷](week11/산본스터디(03_31).ipynb)| 기초 통계, 회귀 분석 및 검증 |
| 김혜련 |                                                           | 기초 통계, 회귀 분석 및 검증 |
| 박지훈 |                                                           | 기초 통계, 회귀 분석 및 검증 |
| 이은용 |                                                           | 기초 통계, 회귀 분석 및 검증 |
| 이혜진 |                                                           | 기초 통계, 회귀 분석 및 검증 |
